...
- [Node.js 20+](https://nodejs.org/) (the underlying stack's own build/dev tooling)
- Python 3.9+

## Quick start

```bash
pipx install antiflock   # or: pip install antiflock
antiflock init
antiflock dev
```
...
Also on npm: `npx antiflock` ([package](https://www.npmjs.com/package/antiflock)) — same CLI, same commands.
