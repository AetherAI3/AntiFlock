...
const (
	NodeService_ListNodes_FullMethodName   = "/antiflock.v1.NodeService/ListNodes"
	NodeService_GetNode_FullMethodName     = "/antiflock.v1.NodeService/GetNode"
	NodeService_UpdateNode_FullMethodName  = "/antiflock.v1.NodeService/UpdateNode"
	NodeService_SuspendNode_FullMethodName = "/antiflock.v1.NodeService/SuspendNode"
	NodeService_RevokeNode_FullMethodName  = "/antiflock.v1.NodeService/RevokeNode"
)
...
type NodeServiceClient interface {
	...
	SuspendNode(ctx context.Context, in *SuspendNodeRequest, opts ...grpc.CallOption) (*SuspendNodeResponse, error)
...
func (c *nodeServiceClient) SuspendNode(ctx context.Context, in *SuspendNodeRequest, opts ...grpc.CallOption) (*SuspendNodeResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(SuspendNodeResponse)
	err := c.cc.Invoke(ctx, NodeService_SuspendNode_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type NodeServiceServer interface {
	...
	SuspendNode(context.Context, *SuspendNodeRequest) (*SuspendNodeResponse, error)
...
func (UnimplementedNodeServiceServer) SuspendNode(context.Context, *SuspendNodeRequest) (*SuspendNodeResponse, error) {
...
func _NodeService_SuspendNode_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(SuspendNodeRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(NodeServiceServer).SuspendNode(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: NodeService_SuspendNode_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(NodeServiceServer).SuspendNode(ctx, req.(*SuspendNodeRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var NodeService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "antiflock.v1.NodeService",
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _NodeService_SuspendNode_Handler,
		},
		{
	...
	Metadata: "antiflock/v1/node.proto",
}
