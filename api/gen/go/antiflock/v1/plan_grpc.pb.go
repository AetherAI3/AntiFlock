...
const (
	PlanService_GetPlan_FullMethodName      = "/antiflock.v1.PlanService/GetPlan"
	PlanService_ApplyPlan_FullMethodName    = "/antiflock.v1.PlanService/ApplyPlan"
	PlanService_RollbackPlan_FullMethodName = "/antiflock.v1.PlanService/RollbackPlan"
)
...
type PlanServiceClient interface {
	...
	RollbackPlan(ctx context.Context, in *RollbackPlanRequest, opts ...grpc.CallOption) (*RollbackPlanResponse, error)
}
...
func (c *planServiceClient) ApplyPlan(ctx context.Context, in *ApplyPlanRequest, opts ...grpc.CallOption) (*ApplyPlanResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ApplyPlanResponse)
	err := c.cc.Invoke(ctx, PlanService_ApplyPlan_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *planServiceClient) RollbackPlan(ctx context.Context, in *RollbackPlanRequest, opts ...grpc.CallOption) (*RollbackPlanResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(RollbackPlanResponse)
	err := c.cc.Invoke(ctx, PlanService_RollbackPlan_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type PlanServiceServer interface {
	...
	RollbackPlan(context.Context, *RollbackPlanRequest) (*RollbackPlanResponse, error)
...
func (UnimplementedPlanServiceServer) ApplyPlan(context.Context, *ApplyPlanRequest) (*ApplyPlanResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method ApplyPlan not implemented")
}
func (UnimplementedPlanServiceServer) RollbackPlan(context.Context, *RollbackPlanRequest) (*RollbackPlanResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method RollbackPlan not implemented")
}
...
func _PlanService_ApplyPlan_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ApplyPlanRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(PlanServiceServer).ApplyPlan(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: PlanService_ApplyPlan_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PlanServiceServer).ApplyPlan(ctx, req.(*ApplyPlanRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _PlanService_RollbackPlan_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(RollbackPlanRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(PlanServiceServer).RollbackPlan(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: PlanService_RollbackPlan_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PlanServiceServer).RollbackPlan(ctx, req.(*RollbackPlanRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var PlanService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "antiflock.v1.PlanService",
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _PlanService_ApplyPlan_Handler,
		},
		{
			MethodName: "RollbackPlan",
			Handler:    _PlanService_RollbackPlan_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "antiflock/v1/plan.proto",
}
