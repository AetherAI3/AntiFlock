...
| Nano watchdog | deterministic parser/evaluator, atomic durable SQLite cursor, audited immutable program admission, proposal-only Core API, and private-token `antiflockctl watchdog` commands | automatic finding scheduling, disable/version lifecycle, replay fixtures, and dashboard/audit presentation |
